        ...
        <tbody>
          ...
          while($commande = mysqli_fetch_assoc($listCommande)){?>
            <tr>
              ...
              <td>
                <script>
                  var test="window.location='pagecontains.php?commande=".$commande['id_commande']."'";
                  
                  
                  </script>
              <button id="btnCommande" class="btnCommande" onclick="window.location='pagecontains.php?commande=<?php echo $commande['id_commande']?>';">Modifier commande </button>
                Plus d'infos
              </td>
            </tr> <?php
          }
